			...
			function(){
				...
				switch(index){
					...
					case "2":
						...
						break;
					case "3":
						$(".remark").addClass("c3").text("这种东西还卖？！");
						break;
					case "4":
						$(".remark").addClass("c4").text("不错，还可以~");
						break;
					case "5":
						$(".remark").addClass("c5").text("Good,一次愉快的体验");
						break;
				}
			},
			//鼠标移出
...
// function pingjia() {
// 	var Mypingjia=document.getElementById('mypingjia');
// 	var Action=Mypingjia.getElementsByClassName('myApingjia');
// 	var Pingjiahtml=Mypingjia.getElementsByClassName('myPingjiahtml');
//     var i=0;
...
// 			for (i=0; i<Action.length; i++) {
// 				Action.className="";
// 				Pingjiahtml[i].style.display='none';
// 			}
//             this.className = 'active';
//             Pingjiahtml[this.index].style.display='block';
//         }
//
//     }
// }
